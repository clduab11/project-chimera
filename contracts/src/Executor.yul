 ...
 *   returns the EOA address and caller() is the Aave Pool. No extra
 *   auth logic is required because the flash-loan callback itself is
    ...
    code {
        ...
        code {
            ...
            function callApprove(token, spender, amount) -> success {
                ...
                // Some ERC20s (USDT) don\	 return a bool. If returndatasize == 0,
