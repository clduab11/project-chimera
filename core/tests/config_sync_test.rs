...
fn assert_configs_eq(a: &PacingConfig, b: &PacingConfig, ctx: &str) {
    assert_eq!(a.max_daily_net_usd, b.max_daily_net_usd,
        "[{ctx}] max_daily_net_usd: {} != {}", a.max_daily_net_usd, b.max_daily_net_usd);
    assert_eq!(a.max_weekly_net_usd, b.max_weekly_net_usd,
        "[{ctx}] max_weekly_net_usd: {} != {}", a.max_weekly_net_usd, b.max_weekly_net_usd);
    assert_eq!(a.max_single_transfer_usd, b.max_single_transfer_usd,
        "[{ctx}] max_single_transfer_usd: {} != {}", a.max_single_transfer_usd, b.max_single_transfer_usd);
    assert_eq!(a.min_interval_hours, b.min_interval_hours,
        "[{ctx}] min_interval_hours: {} != {}", a.min_interval_hours, b.min_interval_hours);
    assert_eq!(a.max_jitter_hours, b.max_jitter_hours,
        "[{ctx}] max_jitter_hours: {} != {}", a.max_jitter_hours, b.max_jitter_hours);
    assert_eq!(a.venue_rotation_count, b.venue_rotation_count,
        "[{ctx}] venue_rotation_count: {} != {}", a.venue_rotation_count, b.venue_rotation_count);
    assert_eq!(a.clean_eoa_pool_size, b.clean_eoa_pool_size,
        "[{ctx}] clean_eoa_pool_size: {} != {}", a.clean_eoa_pool_size, b.clean_eoa_pool_size);
    assert_eq!(a.auto_halt_on_reverts, b.auto_halt_on_reverts,
        "[{ctx}] auto_halt_on_reverts: {} != {}", a.auto_halt_on_reverts, b.auto_halt_on_reverts);
    assert_eq!(a.max_gas_gwei, b.max_gas_gwei,
        "[{ctx}] max_gas_gwei: {} != {}", a.max_gas_gwei, b.max_gas_gwei);
    assert_eq!(a.max_daily_loss_eth, b.max_daily_loss_eth,
        "[{ctx}] max_daily_loss_eth: {} != {}", a.max_daily_loss_eth, b.max_daily_loss_eth);
    assert_eq!(a.min_profit_multiplier, b.min_profit_multiplier,
        "[{ctx}] min_profit_multiplier: {} != {}", a.min_profit_multiplier, b.min_profit_multiplier);
    assert_eq!(a.execute_mode, b.execute_mode,
        "[{ctx}] execute_mode: {} != {}", a.execute_mode, b.execute_mode);
    assert_eq!(a.log_level, b.log_level,
        "[{ctx}] log_level: {} != {}", a.log_level, b.log_level);
    assert_eq!(a.metrics_port, b.metrics_port,
        "[{ctx}] metrics_port: {} != {}", a.metrics_port, b.metrics_port);
    assert_eq!(a.chain_id, b.chain_id,
        "[{ctx}] chain_id: {} != {}", a.chain_id, b.chain_id);
    assert_eq!(a.oracle_staleness_seconds, b.oracle_staleness_seconds,
